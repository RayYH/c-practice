/**
 * Based on https://gist.github.com/kuriringohankamehameha/fceee2e3c126f37fd254ee0acf2b4633
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static LinkedList *linkedlist_insert(LinkedList *list, HtItem *item) {
...
static HtItem *linkedlist_remove(LinkedList *list) {
...
HtItem *create_item(char *key, char *value) {
...
void handle_collision(HashTable *table, unsigned long index, HtItem *item) {
